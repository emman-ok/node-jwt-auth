                        ...
                        <div class="col-12 col-md-auto ">
                            <div class="row  items-center q-col-gutter-sm q-px-sm">
                                <div class="col">
                                    ...
                                    <div class="text-caption text-grey"> RadSystems users are awesome </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <template v-if="showBreadcrumbs">
                                    <q-breadcrumbs class="q-pa-md" v-if="searchText || fieldName">
                                        <template v-if="fieldName">
                                            <q-breadcrumbs-el v-if="$route.query.tag" icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/users"></q-breadcrumbs-el>
                                            <q-breadcrumbs-el v-else icon="arrow_back" class="text-capitalize" :label="fieldName|readable" to="/users"></q-breadcrumbs-el>
                                        ...
                                        <template v-slot:item="props">
                                            <div class="col-sm-3 col-md-2 col-12">
                                                <q-card :bordered="false"   class="text-center nice-shadow-10 animated zoomIn">
                                                    <q-card-section >
                                                        <q-avatar v-ripple @click="navigateTo(`/users/view/${props.row.user_id}`)" class="cursor-pointer" size="100px">
                                                    ...
                                                    <q-card-section v-ripple @click="navigateTo(`/users/view/${props.row.user_id}`)" class="cursor-pointer">
                                                        <div class="text-bold ellipsis">{{ props.row.user_name }}</div>
                                                        <div class="text-caption ellipsis">{{ props.row.email }}</div>
                                                    </q-card-section>
